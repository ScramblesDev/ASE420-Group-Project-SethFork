        ...
        for i in range(4):
            for j in range(4):
                if i * 4 + j in figure:
                    ...
                    pygame.draw.rect(screen, grid_color, [self.start_x + self.block_size * (j + self.shift_x), self.start_y + self.block_size * (i + self.shift_y), self.block_size, self.block_size], 1)
